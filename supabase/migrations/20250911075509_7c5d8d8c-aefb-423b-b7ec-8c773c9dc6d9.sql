...
-- Rimuovi tabelle e enum esistenti se presenti
DROP TABLE IF EXISTS public.project_alerts CASCADE;
DROP TABLE IF EXISTS public.project_expenses CASCADE;
DROP TABLE IF EXISTS public.project_milestones CASCADE;
DROP TABLE IF EXISTS public.projects CASCADE;
DROP TABLE IF EXISTS public.bandi CASCADE;

DROP TYPE IF EXISTS bando_status CASCADE;
